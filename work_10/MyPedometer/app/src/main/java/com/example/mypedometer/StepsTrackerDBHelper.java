...
public class StepsTrackerDBHelper extends SQLiteOpenHelper
{
    ...
    public boolean createStepsEntry(long timeStamp, int stepType)
    {
        ...
        try {
            ...
            if(row!=-1) {
                ...
                System.out.println("+++++++++++ created a new step! on "+ todayDate);
            }
            db.close();
    ...
    {
        System.out.println("getStepsByDate: "+date);
        ...
        System.out.println("#### walking: "+stepType[0]+", jogging: "+stepType[1]+", running: "+stepType[2]);
        return stepType;
    }
